    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.scheduleContainer}>
          ...
          <View style={[styles.scheduleItem, orphanage.open_on_weekends ? styles.scheduleItemGreen : styles.scheduleItemRed]}>
            <Feather name="info" size={40} color={orphanage.open_on_weekends?"#39CC83" : "#cf2727"} />
            <Text style={[styles.scheduleText,orphanage.open_on_weekends ? styles.scheduleTextGreen : styles.scheduleTextRed]}> {orphanage.open_on_weekends?"Atendemos fim de semana" : "Não atendemos fim de semana"} </Text>
          </View>
        </View>
